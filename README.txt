...
#### Purpose
This application serves as a scheduling desktop application for a ficticious global consulting organization 
...
**Important**: In order to run this application, connection to the backend database in a specific version of MySQL is necessary (see version above).
